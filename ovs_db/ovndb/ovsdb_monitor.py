...
from ovs_db.compatibility.di import di
...
from ovs_db.ovndb import row_event
...
class ChassisEvent(row_event.RowEvent):
    ...
    def run(self, event, row, old):
        ...
        di.l3_plugin_schedule_unhosted_gateways()
    ...
    def notify_loop(self):
        while True:
            try:
                ...
                # notify_loop to exit.
                LOG.exception( i18n.translate('Unexpected exception in notify_loop'))
...
class OvnNbIdl(OvnIdl):
    ...
    def unwatch_logical_switch_port_create_events(self):
        ...
        When the ovs_db idl client connects to the ovsdb-server, it gets
...
class OvnBaseConnection(connection.Connection):
    ...
    def get_schema_helper(self):
        ...
        # without the enable_connection_uri() called (since ovs_db-vsctl won't
