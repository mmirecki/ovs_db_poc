...
class Connection(object):
    ...
    @removals.remove(
        ...
        message= i18n.translate("Use idlutils.get_schema_helper(conn, schema, retry=True)"))
    ...
    @removals.remove(
        version='Ocata', removal_version='Pike',
        message= i18n.translate("Use an idl_factory and ovs_db.db.SchemaHelper for filtering"))
